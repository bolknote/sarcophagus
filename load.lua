function love.load()
	...
	font2 = love.graphics.newFont("font/GohuFont-Medium.ttf",11) --11
	font3 = love.graphics.newFont("font/PressStart2P.ttf",12) --11
	...
	shader = love.graphics.newShader('shader.txt')
	shader:send("f",1)
	shader:send("am",0.04)
	shader:send("ci",0)
	shader:send("dying", 0)
	...
	shader2 = love.graphics.newShader('shader2.txt')
	...
	if (operatingSystemName ~= "iOS" and operatingSystemName ~= "Android") then 
		spt.wcursor = love.mouse.newCursor("cur/cursor5.png", 1, 1)
		spt.icursor = love.mouse.newCursor("cur/cursor4.png", 2, 2)
		spt.cursor = love.mouse.newCursor("cur/cursor3.png", 2, 2)
		spt.dcursor = love.mouse.newCursor("cur/cursor1.png", 2, 2)
		spt.cursora = {}
		spt.cursora[1] = love.mouse.newCursor("cur/cursora1.png", 2, 2)
		spt.cursora[2] = love.mouse.newCursor("cur/cursora2.png", 2, 2)
		spt.cursora[3] = love.mouse.newCursor("cur/cursora3.png", 2, 2)
		spt.throwcursor = {}
		spt.throwcursor[1] = love.mouse.newCursor("cur/throw_cursor1.png", 10, 10)
		spt.throwcursor[2] = love.mouse.newCursor("cur/throw_cursor2.png", 10, 10)
		spt.throwcursor[3] = love.mouse.newCursor("cur/throw_cursor3.png", 10, 10)
		spt.throwcursor[4] = love.mouse.newCursor("cur/throw_cursor4.png", 10, 10)
		spt.throwcursor[5] = love.mouse.newCursor("cur/throw_cursor5.png", 10, 10)
