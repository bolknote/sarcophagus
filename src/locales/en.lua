...
msg.network = {
	...
	errors = {
		...
		["world stream sequence gap"] = "A world update was missed. Restoring the connection…",
		["network event sequence gap"] = "A multiplayer event was missed. Restoring the connection…",
