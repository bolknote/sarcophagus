...
msg.game = {
	...
	[35] = "Maps are random, so they're not equal and fair, don't be afraid to restart.{#feae34ff}\nIMPORTANT: The world is deceptively empty. *Deceptively*. Knowledge is power. Inspect everything you can.\nSome items/blocks can be brought to the Machine for useful info and transformations - pay attention to ≈ sign.{#ffffffff}\nPress {#fee761ff}W, A, S, D{#ffffffff} or the {#fee761ff}arrow keys{#ffffffff} to move, {#fee761ff}Space{#ffffffff} to dig/drop (you can also press dig+up or dig+down)",
	[36] = "Not enough power.",
...
msg.menu = {
	...
	new_slot = "Press {#fee761ff}W/S{#ffffffff} or {#fee761ff}↑/↓{#ffffffff} to select, {#fee761ff}Enter{#ffffffff} to start a new game.",
	...
	homepage = "{#ffffffff}Press {#fee761ff}H{#ffffffff} to visit homepage.\n",
	discord = "{#ffffffff}Press {#fee761ff}O{#ffffffff} to visit discord channel.\n",
...
msg.network = {
	...
	quality = "Connection quality: _1_",
	...
	states = {
		...
		resuming_sync = "Replaying missed world changes…",
	...
	errors = {
		...
		invalid_resume_mode = "The client requested an unsupported recovery mode.",
		resume_expired = "The reconnect window expired. Join the world again.",
		...
		transport_disconnect = "The connection was interrupted. Restoring it…",
		reconnect_timeout = "The connection to the host was lost.",
		resume_sync_timeout = "The missed world changes could not be synchronized in time.",
		heartbeat_timeout = "The host stopped responding. Restoring the connection…",
		world_stream_ack_timeout = "World updates stopped being acknowledged. Restoring the connection…",
		event_stream_ack_timeout = "Multiplayer events stopped being acknowledged. Restoring the connection…",
		world_reorder_buffer_overflow = "World updates arrived too far out of order. Restoring the connection…",
		event_reorder_buffer_overflow = "Multiplayer events arrived too far out of order. Restoring the connection…",
		...
		event_catchup_overflow = "Too many events accumulated while disconnected. Please join again.",
		...
		snapshot_resume_unavailable = "The interrupted world transfer could not be restarted.",
...
msg.mapgen = {
	...
	"Shaping the cave",
	"Looking for a safe starting area",
	"Starting area not found — trying again",
	"Starting area found",
	"Tracing connected caves",
	"Filling the world with resources",
	"Placing regions and landmarks",
	"Sealing the world boundary",
	"Calculating the final terrain",
	"Done!",
}

msg.mapgen_ui = {
	title = "Generating world",
	step = "Current step: _1_",
	elapsed = "Elapsed: _1_",
	remaining = "About _1_ remaining",
	estimating = "Estimating remaining time…",
	seconds = "_1_ s",
	minutes = "_1_ min _2_ s",
	failed = "World generation failed",
	retry = "Press Enter to retry or Esc to return to the slots.",
}
