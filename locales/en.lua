...
msg.menu = {
	...
	load_slot = "Press {#fee761ff}W{#ffffffff},{#fee761ff}S{#ffffffff} to select, {#fee761ff}Enter{#ffffffff} to load a game or {#fee761ff}Backspace+Shift{#ffffffff} to delete.",
	new_slot = "Press {#fee761ff}W{#ffffffff},{#fee761ff}S{#ffffffff} to select, {#fee761ff}Enter{#ffffffff} to start a new game.",
